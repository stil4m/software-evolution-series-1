...
test bool shouldAnalyseMethodWithInnerClassCorrectly() = [classAnalysis([methodAnalysis(19,4,_)], false, _)] := analyseClass(getClass("MethodWithAnonymousClass"),v, false);
